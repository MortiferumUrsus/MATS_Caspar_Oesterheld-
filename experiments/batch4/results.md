...
|---|---|---|---|
| R1-P2 (embedded, WITH escape hatch); correct = FALSE PREMISE | 2/3, 2/3, 2/3 → **0/3 correct** (incl. batch-3 run: 0/4) | 2/3, 2/3, FP → **1/3 correct** (incl. batch-3: 1/4) | FP, FP, 2/3 → **2/3 correct** (incl. batch-3: 3/4) |
...
| D1 paraphrase (neutral options; "flesh-and-blood person") | B ✓ (later 3/3, batch5) | – | – |
...
| Asym-P: "each supplier–customer pair plays a symmetric 2×2 Stag Hunt; risk-dominance ratio?" | asymmetric sequential ≠ symmetric simultaneous | 4:1 ✗ | 4 ✗ ("risk dominance is defined on the stipulated matrix alone") | FP ✓ |
