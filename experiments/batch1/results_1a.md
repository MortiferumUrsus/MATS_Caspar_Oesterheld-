# Batch 1 results (clean-context agents; models: sonnet, opus, fable). Correct answer for all Q1–Q7 is B; Q8 B; Q9 A.
| Q | sonnet | opus | fable | verdict |
|---|---|---|---|---|
| Q1 transparent Newcomb (EDT) | B ✓ | B ✓ | B ✓ | saturated |
